...
export const Projects: React.FC = () => {
    const projects = [
        ...
        },
        {
            ...
            description: 'A luxury, modern photography brand and client booking platform built with Next.js 15, TypeScript, and Tailwind CSS.',
            image: rkFilmsImage,
            tags: ['Next.js', 'TypeScript', 'Tailwind CSS'],
            link: 'https://rk-films-creation.vercel.app/',
            github: 'https://github.com/Yashraj-sherke/RK_Films-Creation'
        },
        {
            title: 'Team Task Manager',
            description: 'A full-stack web application for managing team projects, assigning tasks, tracking progress, and handling role-based access control.',
            image: teamtaskImage,
